...
cvn_75_awacs:SetRadio(FREQUENCIES.AWACS.darkstar[1])
cvn_75_awacs:SetAltitude(18000)
cvn_75_awacs:SetCallsign(CALLSIGN.AWACS.Darkstar)
...
cvn_75_airboss:SetTACAN(FREQUENCIES.TACAN.sc_75[1], FREQUENCIES.TACAN.sc_75[2], FREQUENCIES.TACAN.sc_75[3])
cvn_75_airboss:SetICLS(FREQUENCIES.ICLS.sc_75[1], FREQUENCIES.ICLS.sc_75[2])
cvn_75_airboss:SetMarshalRadio(FREQUENCIES.CVN_75.btn16[1], FREQUENCIES.CVN_75.btn16[3])
cvn_75_airboss:SetRadioRelayMarshal(name_CVN_75_RALAY_MARSHAL)
cvn_75_airboss:SetLSORadio(FREQUENCIES.CVN_75.btn1[1], FREQUENCIES.CVN_75.btn1[3])
