...
local awacs_route = {ZONE_AWACS:GetCoordinate(), 20000, 250, 045, 40}
...
AWACS.PlayerGuidance = true -- allow missile warning call-outs.
...
AWACS.NoMissileCalls = false -- suppress missile callouts
