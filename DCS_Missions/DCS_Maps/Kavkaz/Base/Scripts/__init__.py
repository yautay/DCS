...
PATH_SCRIPT_BASES = os.path.join(PATH_MISSION_SCRIPTS, "4_1_BASES.lua")
PATH_SCRIPT_SQUADRONS = os.path.join(PATH_MISSION_SCRIPTS, "4_2_SQUADRONS.lua")
PATH_SCRIPT_AIRWINGS = os.path.join(PATH_MISSION_SCRIPTS, "4_3_AIRWINGS.lua")

PATH_SCRIPT_MANTIS = os.path.join(PATH_MISSION_SCRIPTS, "5_1_MANTIS.lua")
