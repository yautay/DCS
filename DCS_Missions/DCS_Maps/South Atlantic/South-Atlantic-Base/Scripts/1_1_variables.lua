FREQUENCIES = {
    ...
    GROUND = {
        atis_punta_arenas = {118.05, "ATIS Punta Arenas VHF", "AM"},
        tower_punta_arenas_uhf = {250.30, "Tower Punta Arenas UHF", "AM"},
		tower_punta_arenas_vhf = {118.70, "Tower Punta Arenas VHF", "AM"},
    },
    SPECIAL = {
