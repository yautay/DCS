if (dispatcher_blue) then
    -- DETECTION -----------------------------------------------------
    local detection_assets = SET_GROUP:New():FilterCoalitions("blue"):FilterActive():FilterPrefixes("AWACS"):FilterStart()
    ...
    local function spawnCAP(sq_name, template_name, base, palnes, grouping, overhead, cap_zone)
    ...
    local squadrons = {
        f18_cv = {"VFA-37", "ME HORNET", "CVN", 10, 2, 1, zoneCAP_cv},
    }
