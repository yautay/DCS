...
MISSION_Shell_1 = AUFTRAG:NewTANKER(ZONE_SHELL_ONE_AAR:GetCoordinate(), 30000, 440, 6, 20, 1)
...
MISSION_Shell_2 = AUFTRAG:NewTANKER(ZONE_SHELL_TWO_AAR:GetCoordinate(), 28000, 440, 6, 20, 1)
...
MISSION_Shell_3 = AUFTRAG:NewTANKER(ZONE_SHELL_THREE_AAR:GetCoordinate(), 30000, 440, 6, 20, 1)
