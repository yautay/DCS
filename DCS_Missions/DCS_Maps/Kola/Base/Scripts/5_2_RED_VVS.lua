...
Squadron_A50_ESCORT = SQUADRON:New(TEMPLATE.AIR.ADVERSARY.RED_ESCORT, 6, "RED_AWACS_ESCORT") -- taking a template with 2 planes here, will result in a group of 2 escorts which can fly in formation escorting the AWACS.
Squadron_A50_ESCORT:AddMissionCapability({ AUFTRAG.Type.ESCORT }, 100)
Squadron_A50_ESCORT:AddMissionCapability({ AUFTRAG.Type.INTERCEPT }, 50)
...
VVS:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_INTERCEPT, -1, { AUFTRAG.Type.INTERCEPT }, 100)
VVS:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_INTERCEPT, -1, { AUFTRAG.Type.PATROLZONE, AUFTRAG.Type.CAP }, 60)

VVS:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_ESCORT, -1, { AUFTRAG.Type.INTERCEPT }, 30)
VVS:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_ESCORT, -1, { AUFTRAG.Type.PATROLZONE, AUFTRAG.Type.CAP }, 20)
VVS:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_ESCORT, -1, { AUFTRAG.Type.ESCORT }, 50)

VVS:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_CAP, -1, { AUFTRAG.Type.INTERCEPT }, 50)
VVS:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_CAP, -1, { AUFTRAG.Type.PATROLZONE, AUFTRAG.Type.CAP}, 100)
