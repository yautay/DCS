...
RED.Squadrons.AWACS = SQUADRON:New(TEMPLATE.AIR.ADVERSARY.RED_AWACS, 2, "Red EWR AWACS")
...
RED.Airwings.Severomorsk_3:NewPayload(TEMPLATE.AIR.ADVERSARY.RED_INTERCEPT, -1, { AUFTRAG.Type.INTERCEPT }, 100)
...
Severomorsk_3_Alert5_INTERCEPT:SetRequiredAssets(3)
...
RED.Commander:AddMission(Murmansk_International_Mission_TANKER)
