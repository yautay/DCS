...
Murmansk_International_Alert5_TANKER=AUFTRAG:NewTANKER(ZoneRedTankers, 28000, UTILS.KnotsToAltKIAS(363, 28000), 335, 30, Unit.RefuelingSystem.PROBE_AND_DROGUE)
Murmansk_International_Alert5_TANKER:SetPriority(2)
Murmansk_International_Alert5_TANKER:SetRequiredAssets(1)
Murmansk_International_Alert5_TANKER:AssignSquadrons({RED.Squadrons.AAR})
Murmansk_International_Alert5_TANKER:SetRequiredEscorts(1, 1)
