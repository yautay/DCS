...
cvn_75_tanker:SetRadio(FREQUENCIES.AAR.navy_one[1])
...
cvn_75_airboss:SetTACAN(TACAN.sc_75[1], TACAN.sc_75[2], TACAN.sc_75[3])
cvn_75_airboss:SetICLS(ICLS.sc_75[1], ICLS.sc_75[2])
