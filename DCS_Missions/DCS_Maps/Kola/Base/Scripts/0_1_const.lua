...
TEMPLATE = {
    ...
    AIR = {
        ...
        ADVERSARY = {
            ...
            F5_SINGLETON = { "TEMPLATE_F5", "VVR", 10, "F-5x1" },
            F86_SINGLETON = { "TEMPLATE_F86", "VVR", 5, "F-86x1" },
            JAS39_SINGLETON = { "TEMPLATE_JAS39", "BVR", 100, "JAS-39x1" },
            MIG15_SINGLETON = { "TEMPLATE_MiG15", "DOG", 5, "MiG-15x1" },
            MIG19_SINGLETON = { "TEMPLATE_MiG19", "VVR", 10, "MiG-19x1" },
            MIG21_SINGLETON = { "TEMPLATE_MiG21", "VVR", 30, "MiG-21x1" },
            MIG29_SINGLETON = { "TEMPLATE_MiG-29-GUNS", "DOG", 5, "MiG-29x1" },
            MIG31_SINGLETON = { "TEMPLATE_MiG31", "BVR", 200, "MiG-31x1" },
            F16_PAIR = { "TEMPLATE_F16-2", "BVR", 80, "F-16x2" },
            F5_PAIR = { "TEMPLATE_F5-2", "VVR", 10, "F-5x2" },
            F86_PAIR = { "TEMPLATE_F86-2", "VVR", 5, "F-86x2" },
            JAS39_PAIR = { "TEMPLATE_JAS39-2", "BVR", 100, "JAS-39x2" },
            MIG15_PAIR = { "TEMPLATE_MiG15-2", "DOG", 5, "MiG-15x2" },
            MIG19_PAIR = { "TEMPLATE_MiG19-2", "VVR", 10, "MiG-19x2" },
            MIG21_PAIR = { "TEMPLATE_MiG21-2", "VVR", 30, "MiG-21x2" },
            MIG31_PAIR = { "TEMPLATE_MiG31-2", "BVR", 200, "MiG-31x2" },
            MIG29_PAIR = { "TEMPLATE_MiG-29-GUNS-2", "DOG", 5, "MiG-29x2" },
        },
        AAR = {
