...
PATH_SCRIPT_SPAWN = os.path.join(PATH_MISSION_SCRIPTS, "1_3_spawn.lua")
...
PATH_SCRIPT_BLUE_MAP_MARKS = os.path.join(PATH_MISSION_SCRIPTS, "4_4_BLUE_MAP_MARKS.lua")
PATH_SCRIPT_RED_VVS = os.path.join(PATH_MISSION_SCRIPTS, "5_2_RED_VVS.lua")
