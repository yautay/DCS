...
cvn_75_tanker = RECOVERYTANKER:New(UNIT:FindByName(TEMPLATE.SEA.CVN_75), TEMPLATE.AIR.CVN.CVN_TANKER)
...
-- E-2D AWACS
cvn_75_awacs = RECOVERYTANKER:New(UNIT:FindByName(TEMPLATE.SEA.CVN_75), TEMPLATE.AIR.CVN.CVN_AWACS)
...
-- Rescue Helo
cvn_75_sar = RESCUEHELO:New(UNIT:FindByName(TEMPLATE.SEA.CVN_75), TEMPLATE.AIR.CVN.CVN_SAR)
cvn_75_sar:Start()

-- AIRBOSS object.
cvn_75_airboss = AIRBOSS:New(TEMPLATE.SEA.CVN_75)
...
cvn_75_airboss:EnableSRS(SRS_PATH, SRS_PORT)
...
local case2_1 = cvn_75_airboss:AddRecoveryWindow("07:02", "08:00", 2, 30, true, 28)
local case1_2 = cvn_75_airboss:AddRecoveryWindow("09:45", "11:00", 1, nil, true, 28)
...
lha_1_airboss:EnableSRS(SRS_PATH, SRS_PORT)
