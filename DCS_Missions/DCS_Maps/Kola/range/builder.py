...
from DCS_Missions.DCS_Maps.Kola.range.Scripts import *
from DCS_Missions.lib import *
...
scripts_order["\n--4_4_BLUE_MAP_MARKS.lua\n"] = PATH_SCRIPT_BLUE_MAP_MARKS
scripts_order["\n--5_2_RED_VVS.lua\n"] = PATH_SCRIPT_RED_VVS
...
content_scripts = ""
content_frameworks = ""
static_script_guard = "if __KOLA_RANGE_LOADED then\n\tenv.info('CUSTOM *** KOLA RANGE ALREADY LOADED - SKIPPING STATIC SCRIPT *** ')\n\treturn\nend\n__KOLA_RANGE_LOADED = true\n\n"
...
append_script(SCRIPTS_FILE, static_script_guard)
