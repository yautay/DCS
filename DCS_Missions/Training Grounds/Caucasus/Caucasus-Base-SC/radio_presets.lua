...
-- -- 225/399,97
local f14_159 = {
    {"1", FREQUENCIES.GROUND.vaziani},
    {"2", FREQUENCIES.ELINT.kutasi},
    {"3", FREQUENCIES.ELINT.atis_kutasi},
    {"4", FREQUENCIES.AAR.arco},
    {"6", FREQUENCIES.CV.marshal},
    {"7", FREQUENCIES.CV.lso},
    {"10", FREQUENCIES.AWACS.darkstar},
    {"11", FREQUENCIES.AWACS.wizard},
    {"15", FREQUENCIES.AAR.common},
}
-- -- 30/399,97
local f14_182 = {
    {"1", FREQUENCIES.GROUND.vaziani},
...
-- 30/155,97
local f16_222 = {
    {"1", FREQUENCIES.GROUND.atis_vaziani},
}
-- 30/399,97
local f18_210_1 = {
    {"1", FREQUENCIES.GROUND.vaziani},
