...
local ordered_elint_freq = {
    FREQUENCIES.ELINT.hormuz_hi,
    FREQUENCIES.ELINT.hormuz_lo,
    FREQUENCIES.ELINT.hormuz_fm,
    FREQUENCIES.ELINT.atis_hormuz_hi,
    FREQUENCIES.ELINT.atis_hormuz_lo,
    FREQUENCIES.ELINT.atis_hormuz_fm,
    FREQUENCIES.ELINT.kish_hi,
    FREQUENCIES.ELINT.kish_lo,
    FREQUENCIES.ELINT.kish_fm,
    FREQUENCIES.ELINT.atis_kish_hi,
    FREQUENCIES.ELINT.atis_kish_lo,
    FREQUENCIES.ELINT.atis_kish_fm
}
