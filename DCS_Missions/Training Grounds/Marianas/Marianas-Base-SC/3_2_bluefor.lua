...
AWACS_Darkstar =
    ...
    function(darkstar_11)
        ...
        darkstar_11:CommandSetFrequency(251)
    end
):InitRepeatOnLanding()
-- AWACS_Overlord =
...
-- ###                      CHROME                         ###
-- ###########################################################
HomePlateATIS = ATIS:New(AIRBASE.MarianaIslands.Andersen_AFB, 118.80)
HomePlateATIS:SetRadioRelayUnitName("AWACS Darkstar")
HomePlateATIS:SetTACAN(54)
-- HomePlateATIS:SetVOR(113.70)
HomePlateATIS:SetTowerFrequencies({250.10, 126.2})
HomePlateATIS:AddILS(109.35, "24R")
HomePlateATIS:AddILS(110.15, "24L")
HomePlateATIS:AddILS(109.30, "06L")
HomePlateATIS:AddILS(110.10, "06R")
-- HomePlateATIS:AddNDBinner(368.00)
HomePlateATIS:SetSRS("C:\\DCS-SimpleRadio-Standalone", "female", "en-US")
HomePlateATIS:SetMapMarks()
HomePlateATIS:Start()
