#!/usr/bin/env python3
"""Bundle src/*.lua into MosieNavigator.lua for the DCS runtime.
...
SRC_DIR = HERE / "src"
BUNDLE = HERE / "MosieNavigator.lua"
...
def main() -> int:
    ...
    if "--check" in sys.argv:
        ...
        if current != content:
            print(
                "MosieNavigator.lua is out of sync with src/ — run: python3 build.py",
                file=sys.stderr,
            )
            return 1
